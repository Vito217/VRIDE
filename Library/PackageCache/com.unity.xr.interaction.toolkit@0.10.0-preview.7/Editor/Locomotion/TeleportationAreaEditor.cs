...
{
    [CustomEditor(typeof(TeleportationArea)), CanEditMultipleObjects]
    public class TeleportationAreaEditor : Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            const string initializedKey = "XRI." + nameof(TeleportationAreaEditor) + ".Initialized";
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.ObjectField(EditorGUIUtility.TrTempContent("Script"), MonoScript.FromMonoBehaviour((TeleportationArea)target), typeof(TeleportationArea), false);
